...
- 3~5문장으로 간결하게, 오늘 뭘 하면 되는지 행동 위주로 답하라. 번호·기호로 항목을 나열하지 말고 자연스러운 문장으로 풀어써라 — "주의할 점", "~하는 법"처럼 항목이 여럿일 만한 질문도 가장 중요한 것 위주로 추려 문장 안에 녹여라.
